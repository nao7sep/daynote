# Package DayNote for Windows into dist/: an Inno Setup .exe installer + a
...
# Self-contained win-x64 publish -> a folder of DayNote.exe + its runtime.
...
& $iscc "/DMyAppVersion=$Version" scripts/daynote.iss
