...
# Package DayNote for macOS into dist/: a .dmg installer + a portable .zip of the
# .app. Run by CI on macos-latest and runnable locally. Per the
...
APP_NAME="DayNote"
PROJECT="src/DayNote/DayNote.csproj"
...
# assembles and ad-hoc-signs publish/DayNote.app as part of the publish.
