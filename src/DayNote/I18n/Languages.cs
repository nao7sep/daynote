...
/// <summary>
/// The interface languages DayNote speaks (localization conventions): the ten tags, the name each
...
{
    /// <summary>The saved value that means "follow the computer", the default in <c>config.json</c>.</summary>
    internal const string System = Core.Configuration.AppConfig.SystemLanguage;
